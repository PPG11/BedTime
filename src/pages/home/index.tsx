...
export default function Index() {
  ...
  useShareAppMessage(() => getShareAppMessageOptions(shareUid ?? undefined));
  useShareTimeline(() => getShareTimelineOptions(shareUid ?? undefined));
    ...
    try {
      ...
      try {
        if (canUseCloud && userDoc) {
          ...
          rewardCandidate = pickRandomLocalGoodnightMessage(effectiveUid ?? undefined);
        }
      } catch (error) {
